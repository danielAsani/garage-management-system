...
- Authentification web avec sessions Django
- API JWT avec access token et refresh token
...
Le champ `amount` est calcule automatiquement cote serveur en francs congolais avec:
